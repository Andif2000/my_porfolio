        ...
        <div name='contact'
            ...
            <div
                ...
                <div className='flex justify-center items-center'>
                    <form action="https://getform.io/f/49b2e121-f9fc-4cad-88d6-1e25e964b8d0"
                        method='POST'
                        ...
                        <button
                            className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's talk me</button>
                    </form>
                </div>
            </div>
        </div>
